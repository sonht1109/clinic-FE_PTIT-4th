...
export const getData =
  ({
    ...
    (dispatch: any) => {
      requestInterToken({
        method: 'GET',
        url: API_URL.OFFICER_ACCOUNT.GET,
        params: {
          pageNumber,
          pageSize,
          status,
...
export const handleAction = ({ actionType, userType, id }: { actionType: string, userType: string, id: string }) => (dispatch: any) => {
  requestInterToken({
    method: 'POST',
